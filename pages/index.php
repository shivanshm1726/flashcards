...
<body class="min-h-screen bg-gray-50 dark:bg-gray-900 font-poppins transition-colors duration-300">
    ...
    <header class="bg-gradient-to-r from-purple-700 to-indigo-700 dark:from-purple-800 dark:to-indigo-800 text-white p-6 shadow-lg">
        <div class="max-w-6xl mx-auto flex justify-between items-center">
            <h1 class="text-3xl font-bold tracking-wide">Welcome, <?php echo htmlspecialchars($username); ?>!</h1>
            <div class="flex items-center space-x-6">
                <form method="GET" action="search.php" class="flex items-center">
                    <input type="text" name="q" placeholder="Search flashcards..." class="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-l-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 dark:bg-gray-700 dark:text-white transition duration-300">
                    <button type="submit" class="bg-purple-600 dark:bg-purple-700 text-white px-4 py-2 rounded-r-md hover:bg-purple-700 dark:hover:bg-purple-800 transition duration-300">Search</button>
                </form>
    ...
    <main class="p-6">
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div class="text-center text-gray-600 dark:text-gray-300 italic text-lg animated-section"><?php echo htmlspecialchars($motivational_message); ?></div>

                <!-- Daily Challenge -->
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 animated-section">
                    <h2 class="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Daily Challenge</h2>
                    <p class="text-gray-600 dark:text-gray-300 mb-4"><?php echo $daily_challenge; ?>
                        <?php if ($challenge_completed): ?>
                            <span class="text-green-600 dark:text-green-400">(Completed!)</span>
                        <?php endif; ?>
                    </p>
                    <a href="view_decks.php" class="text-purple-600 dark:text-purple-400 hover:underline">Start Challenge</a>
                </div>

                <!-- Quick Actions -->
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 animated-section">
                    <h2 class="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Quick Actions</h2>
                ...
                <!-- Study Goal -->
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 animated-section">
                    <h2 class="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Study Goal</h2>
                    <?php if ($study_goal && $study_goal['target_decks'] > 0 && !$goal_completed): ?>
                        <p class="text-gray-600 dark:text-gray-300">Target: <?php echo $study_goal['target_decks']; ?> decks to master <?php echo $study_goal['period'] === 'daily' ? 'today' : 'this week'; ?></p>
                        <p class="text-gray-600 dark:text-gray-300">Progress: <?php echo $progress; ?>/<?php echo $study_goal['target_decks']; ?> decks</p>
                        <p class="text-gray-500 dark:text-gray-400 text-sm">Mastered Decks: <?php echo implode(', ', $mastered_titles) ?: 'None'; ?></p>
                    ...
                    <?php else: ?>
                        <?php if ($goal_completed): ?>
                            <p class="text-green-500 dark:text-green-400 font-semibold mb-4">Congratulations! You've completed your study goal!</p>
                        <?php endif; ?>
                        <p class="text-gray-600 dark:text-gray-300 mb-4">Set a new goal to stay on track.</p>
                        <form action="set_study_goal.php" method="POST" class="space-y-4">
                            <div class="flex space-x-4">
                                <div class="flex-1">
                                    <label for="target_decks" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Target Decks</label>
                                    <input type="number" id="target_decks" name="target_decks" min="1" class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 dark:bg-gray-700 dark:text-white transition duration-300" required>
                                </div>
                                <div class="flex-1">
                                    <label for="period" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Period</label>
                                    <select id="period" name="period" class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 dark:bg-gray-700 dark:text-white transition duration-300">
                    ...
                    <?php endif; ?>
                    <h3 class="text-lg font-semibold mt-6 mb-2 text-gray-800 dark:text-white">Recent Goals</h3>
                    <?php
                    ...
                    <?php if (empty($goal_history)): ?>
                        <p class="text-gray-600 dark:text-gray-300">No completed goals yet.</p>
                    <?php else: ?>
                ...
                <!-- Tip of the Day -->
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 animated-section">
                    <h2 class="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Tip of the Day</h2>
                    <p class="text-gray-600 dark:text-gray-300">Did you know? Studying in short bursts can boost retention. Try 25-minute sessions! Click on Start Studying to create Custom Study Sessions </p>
                </div>
            </div>
            ...
            <div class="space-y-6">
                <!-- Decks to Review -->
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 animated-section">
                    <h2 class="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Decks to Review</h2>
                    <?php if (empty($decks_to_review)): ?>
                        <p class="text-gray-600 dark:text-gray-300">No decks to review. Start studying to see decks here!</p>
                    <?php else: ?>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <?php foreach ($decks_to_review as $deck): ?>
                                <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-200 dark:border-gray-600 animated-card">
                                    <h3 class="text-lg font-semibold text-gray-800 dark:text-white mb-2"><?php echo htmlspecialchars($deck['title']); ?></h3>
                                    <p class="text-gray-600 dark:text-gray-300 text-sm mb-4 line-clamp-2"><?php echo htmlspecialchars($deck['description']); ?></p>
                                    <p class="text-sm text-gray-500 dark:text-gray-400">Flashcards: <?php echo $deck['total_flashcards']; ?></p>
                                    <div class="mt-4">
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 animated-section">
                    <h2 class="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Recently Created Decks</h2>
                    <?php if (empty($recent_decks)): ?>
                        <p class="text-gray-600 dark:text-gray-300">No recently created decks. Create some to see them here!</p>
                    <?php else: ?>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
...
if ($study_goal && $study_goal['target_decks'] > 0) {
  $stmt = $pdo->prepare("
    SELECT COUNT(*) 
    FROM user_deck_mastery udm
    LEFT JOIN shared_decks sd ON udm.deck_id = sd.deck_id AND sd.shared_with = ?
    WHERE (udm.user_id = ? OR sd.shared_with = ?) AND udm.is_mastered = 1
  ");
  $stmt->execute([$user_id, $user_id, $user_id]);
  $progress = $stmt->fetchColumn();
  ...
  if ($progress >= $study_goal['target_decks']) {
    ...
    $stmt->execute([$user_id, $study_goal['target_decks'], $study_goal['period']]);
    $stmt = $pdo->prepare("
      UPDATE user_deck_mastery udm
      LEFT JOIN shared_decks sd ON udm.deck_id = sd.deck_id AND sd.shared_with = ?
      SET udm.is_mastered = 0, udm.mastered_at = NULL
      WHERE (udm.user_id = ? OR sd.shared_with = ?) AND udm.is_mastered = 1
    ");
    $stmt->execute([$user_id, $user_id, $user_id]);
    $stmt = $pdo->prepare("DELETE FROM study_goals WHERE id = ? AND user_id = ?");
...
try {
  $stmt = $pdo->prepare("
      ...
      LEFT JOIN flashcards f ON d.id = f.deck_id
      LEFT JOIN user_deck_mastery udm ON d.id = udm.deck_id AND udm.user_id = ?
      WHERE d.user_id = ? AND COALESCE(udm.is_mastered, 0) = 0 AND d.last_studied_at IS NOT NULL
      GROUP BY d.id
      ORDER BY d.last_studied_at DESC
      LIMIT 4
  ");
...
// Fetch recently created decks (all users)
$stmt = $pdo->prepare("
  SELECT d.*, COUNT(f.id) AS total_flashcards
  FROM decks d
  LEFT JOIN flashcards f ON d.id = f.deck_id
...
<body class="min-h-screen bg-gray-50 font-poppins">
    ...
    <header class="bg-gradient-to-r from-purple-700 to-indigo-700 text-white p-6 shadow-lg">
        <div class="max-w-6xl mx-auto flex justify-between items-center">
            ...
            <div class="flex items-center space-x-6">
                <form method="GET" action="search.php" class="flex items-center">
                    <input type="text" name="q" placeholder="Search flashcards..." class="px-4 py-2 border border-gray-300 rounded-l-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500">
                        ...
                        <form action="set_study_goal.php" method="POST" class="space-y-4">
                            <div class="flex space-x-4">
                                <div class="flex-1">
                                    ...
                                    <input type="number" id="target_decks" name="target_decks" min="1" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500" required>
                                </div>
                                <div class="flex-1">
                                    <label for="period" class="block text-sm font-medium text-gray-700">Period</label>
                                    <select id="period" name="period" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500">
                                        <option value="daily">Daily</option>
                                        <option value="weekly">Weekly</option>
                                    </select>
                                </div>
